# rdgp_top_genes_by_high_impact_burden
...
Genes with higher counts of HIGH-impact variants include:

- mucin genes (MUC3A, MUC16)  
- immune-related genes (HLA family)  

### Key Insight

> High-impact variant counts can be inflated in:

- repetitive regions  
- poorly mappable regions  
- highly polymorphic loci  

These results require careful interpretation and additional filtering.
