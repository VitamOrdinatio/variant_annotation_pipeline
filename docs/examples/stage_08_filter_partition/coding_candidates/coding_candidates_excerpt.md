...
tsvhead < coding_candidates.tsv > docs/examples/stage_08_filter_partition/coding_candidates/coding_candidates_excerpt.md
tsvhead < coding_candidates.tsv > docs/examples/stage_08_filter_partition/coding_candidates/coding_candidates_excerpt.tsv
```
