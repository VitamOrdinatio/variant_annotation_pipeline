...
awk -F'\t' 'NR==1 || $13 ~ /missense_variant/' "$TSV" | head -n 11 > "$OUTDIR/stage_07_missense_examples.tsv"
awk -F'\t' 'NR==1 || $13 ~ /missense_variant/' "$TSV" | head -n 11 > "$OUTDIR/stage_07_missense_examples.md"
```
