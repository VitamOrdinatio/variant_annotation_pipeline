# stage_07_stop_gained_examples.md
...
awk -F'\t' 'NR==1 || $13 ~ /stop_gained/' "$TSV" | head -n 11 > "$OUTDIR/stage_07_stop_gained_examples.tsv"
awk -F'\t' 'NR==1 || $13 ~ /stop_gained/' "$TSV" | head -n 11 > "$OUTDIR/stage_07_stop_gained_examples.md"
```
