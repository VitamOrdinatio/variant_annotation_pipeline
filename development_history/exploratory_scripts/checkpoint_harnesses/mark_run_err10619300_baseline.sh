...
CONFIG="config/config.mark.err10619300.baseline.yaml"
LOGFILE="/root/Desktop/mark_err10619300_baseline_$(date -u +%Y%m%dT%H%M%SZ).txt"
...
config_path = "config/config.mark.err10619300.baseline.yaml"
...
PY
  ...
  echo
  echo "===== STARTING ERR10619300 BASELINE RUN ====="
